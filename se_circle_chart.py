...
import subprocess
try:
    a0 = np.genfromtxt('data_chart\\250113se_circle_chart.csv', delimiter=",", skip_header=1)
...
ax.set_xlim([0.001, 1])
ax.set_ylim([0, 240])
ax.set_title(r'Shield Effect of a Round Aperture')
...
PdfFile = 'data_chart\\250113se_circle_chart.pdf'
fig.savefig(PdfFile)
